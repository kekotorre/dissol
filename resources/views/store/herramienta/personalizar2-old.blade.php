...
@section('contenido')
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12" style="border: 1px  black;">
                <canvas id="pizarra" height="1024" width="500px" style="border: 2px solid red;"></canvas>
            </div>
        </div>
...
<script type="text/javascript">
    console.log('{{ $producto->portada_high}}');


var canvas = new fabric.Canvas('pizarra');
canvas.backgroundColor('{{ "../" . $producto->portada_high}}', canvas.renderAll.bind(canvas));

    var imgUrl = '{{ "../" . $producto->portada_high}}';
...
//canvas.setBackgroundImage('{{ "../" . $producto->portada_high}}', canvas.renderAll.bind(canvas));
//canvas.setZoom(0.3);

    //canvas.backgroundImage.scaleToWidth(100);
    //canvas.backgroundImage.scaleToHeight(100);
    //canvas.setDimensions({width: 100, height: 100});
    canvas.renderAll();


//canvas.backgroundImage.scaleToWi(1060);
...
var composicion = '<?php echo $producto->composicion_ejemplo ?>';

   <?php //echo $producto->composicion_ejemplo ?>
